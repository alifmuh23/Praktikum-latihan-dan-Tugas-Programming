...
print('1.'+'|'+djual[0][0].ljust(13)+'|'+djual[1][0].ljust(19)+'|'+f'Rp{djual[2][0]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{3*r*djual[2][0]},-'.rjust(14)+'|')
print('2.'+'|'+djual[0][1].ljust(13)+'|'+djual[1][1].ljust(19)+'|'+f'Rp{djual[2][1]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{3*r*djual[2][1]},-'.rjust(14)+'|')
print('3.'+'|'+djual[0][2].ljust(13)+'|'+djual[1][2].ljust(19)+'|'+f'Rp{djual[2][2]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{3*r*djual[2][2]},-'.rjust(14)+'|')
print('4.'+'|'+djual[0][3].ljust(13)+'|'+djual[1][3].ljust(19)+'|'+f'Rp{djual[2][3]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{3*r*djual[2][3]},-'.rjust(14)+'|')
print('5.'+'|'+djual[0][4].ljust(13)+'|'+djual[1][4].ljust(19)+'|'+f'Rp{djual[2][4]*r},-'.rjust(15)+'|'+'3'.center(8)+'|'+f'Rp{3*r*djual[2][4]},-'.rjust(14)+'|')
print('-'*77)
print(f'Subtotal = Rp{3*r*sum(djual[2])},-'.rjust(77))
print('-'*77)
rata = (sum(djual[2]))/(len(djual[2]))*3*r
print(f'''Summary:
Harga tertinggi adalah    : Rp{max(djual[2])*r},-  ({djual[0][1]} - {djual[1][0]})
Harga terendah adalah     : Rp{min(djual[2])*r},-  ({djual[0][3]} - {djual[1][3]})
Harga Rata-Rata pembelian : Rp{float(rata):.2f}''')
print('\n')
kota = mdata[2]
tanggal = mdata[-1]
gabung = ((kota+", "+tanggal).rjust(77))
print(gabung)
print("\n"*3)
nama = mdata[3]
akhir = "-"*14
print(nama.rjust(72))
print(akhir.rjust(74))
print(f'MANAGER'.rjust(71))
